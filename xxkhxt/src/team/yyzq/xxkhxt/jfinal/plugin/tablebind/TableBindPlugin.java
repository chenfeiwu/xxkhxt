package team.yyzq.xxkhxt.jfinal.plugin.tablebind;
...
import team.yyzq.xxkhxt.jfinal.kit.ClassSearcher;
...
//      includeClasses = ClassSearcherExt.of(Model.class).includepaths(includeClassPaths).injars(includeJars).includeAllJarsInLib(includeAllJarsInLib).search();
      includeClasses = ClassSearcher.of(Model.class).injars(includeClassPaths).search();
    }
    TableBind tb = null;
